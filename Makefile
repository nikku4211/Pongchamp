...
BUILD       :=  build
LIBBUTANO   :=  ../butano/butano-13.3.1/butano
PYTHON      :=  python
SOURCES     :=  src ../butano/butano-13.3.1/common/src
INCLUDES    :=  include ../butano/butano-13.3.1/common/include
DATA        :=
GRAPHICS    :=  graphics ../butano/butano-13.3.1/common/graphics
AUDIO       :=  audio
DMGAUDIO    :=  dmg_audio
ROMTITLE    :=  ADAPARE
ROMCODE     :=  SBTP
